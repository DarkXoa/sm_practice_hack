...
cp resources/sm_orig.sfc build/smhack20_spazer.sfc && cd src && ..\tools\asar --no-title-check -DFEATURE_SD2SNES=0 -DCATEGORY=4 main.asm ../build/smhack20_spazer.sfc && cd ..

cp resources/sm_orig.sfc build/InfoHUD_2.0.8a_DarkXoa.sfc && cd src && ..\tools\asar --no-title-check -DFEATURE_SD2SNES=0 -DCATEGORY=5 main.asm ../build/InfoHUD_2.0.8a_DarkXoa.sfc && cd ..
...
cp resources/sm_orig.sfc build/smhack20_sd2snes_spazer.sfc && cd src && ..\tools\asar --no-title-check -DFEATURE_SD2SNES=1 -DCATEGORY=4 main.asm ../build/smhack20_sd2snes_spazer.sfc && cd ..

cp resources/sm_orig.sfc build/InfoHUD_SD2SNES_2.0.8a_DarkXoa.sfc && cd src && ..\tools\asar --no-title-check -DFEATURE_SD2SNES=1 -DCATEGORY=5 main.asm ../build/InfoHUD_SD2SNES_2.0.8a_DarkXoa.sfc && cd ..
